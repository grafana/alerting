...
func (am *GrafanaAlertmanager) ListSilences(filter []string) (apimodels.GettableSilences, error) {
...
func (am *GrafanaAlertmanager) GetSilence(silenceID string) (apimodels.GettableSilence, error) {
...
func (am *GrafanaAlertmanager) CreateSilence(ps *apimodels.PostableSilence) (string, error) {
